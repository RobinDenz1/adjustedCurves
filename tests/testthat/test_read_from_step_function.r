...
test_that("surv, t = 0, start", {
  expect_equal(adjustedCurves:::read_from_step_function(0,
                                                        step_data=test_dat,
                                                        est="surv"),
               1)
})
...
test_that("surv, t = 0.2, on jump", {
  expect_equal(adjustedCurves:::read_from_step_function(0.2,
                                                        step_data=test_dat,
                                                        est="surv"),
               0.8)
})
...
test_that("surv, t = 0.4, in slope = 0", {
  expect_equal(adjustedCurves:::read_from_step_function(0.4,
                                                        step_data=test_dat,
                                                        est="surv"),
               0.76)
})
...
test_that("surv, t = 0.63, end", {
  expect_equal(adjustedCurves:::read_from_step_function(0.63,
                                                        step_data=test_dat,
                                                        est="surv"),
               0.3)
})
