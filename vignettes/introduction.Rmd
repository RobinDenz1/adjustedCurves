...
plot(adjsurv)
```
This plot function comes with many options which are listed in the documentation. To plot the pointwise confidence intervals, we can set the argument `conf_int` to TRUE:
